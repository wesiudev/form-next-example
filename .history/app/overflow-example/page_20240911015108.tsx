        ...
        {catImages.map((imgSrc, index) => (
          <img
            ...
            style={{
              ...
              margin: "5px",
              visibility:
                catImages.length - index > index ? "hidden" : "visible",
            }}
          />
        ))}
        <div className="w-[10vw] aspect-square flex items-center justify-center bg-red-500 text-white font-bold text-xl">
          {hiddenImages}
        </div>
      </div>
